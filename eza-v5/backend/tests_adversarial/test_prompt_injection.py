# -*- coding: utf-8 -*-
"""
Prompt Injection Attack Tests (20 tests)
Tests prompt injection scenarios from redteam_matrix_120.json
"""
import pytest
...
@pytest.mark.parametrize("scenario", [
    pytest.param(s, id=s["id"]) for s in get_scenarios_by_category("prompt_injection")
])
async def test_prompt_injection_scenario(scenario):
    """Test a single prompt injection scenario"""
