# -*- coding: utf-8 -*-
"""
Emoji Bypass Attack Tests (10 tests)
Tests emoji bypass scenarios from redteam_matrix_120.json
"""
import pytest
...
@pytest.mark.parametrize("scenario", [
    pytest.param(s, id=s["id"]) for s in get_scenarios_by_category("emoji_bypass")
])
async def test_emoji_bypass_scenario(scenario):
    """Test a single emoji bypass scenario"""
