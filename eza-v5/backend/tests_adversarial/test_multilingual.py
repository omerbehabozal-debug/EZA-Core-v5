...
Tests multilingual scenarios from redteam_matrix_120.json
"""
import pytest
...
@pytest.mark.parametrize("scenario", [
    pytest.param(s, id=s["id"]) for s in get_scenarios_by_category("multilingual")
])
async def test_multilingual_scenario(scenario):
    """Test a single multilingual scenario"""
