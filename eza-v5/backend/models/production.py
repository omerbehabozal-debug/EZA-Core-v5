...
class User(Base):
    ...
    # public_honorific lives in migration add_user_public_honorific_v1.
    # Do not map it on User until production has run that upgrade — a mapped
    # column makes every login/register SELECT/INSERT 500 if the column is absent.
