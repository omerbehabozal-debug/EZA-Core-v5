...
export default function IdentityModal({ open, onClose }: IdentityModalProps) {
  ...
  useModalFocusTrap({
    ...
    initialFocusRef: registerCtaRef,
  });
      ...
      >
        ...
        <div className="mt-6 flex flex-col gap-2">
          <Link
            ...
            href={registerHref}
            onClick={onClose}
            className="saina-modal-cta saina-modal-cta--primary inline-flex w-full items-center justify-center rounded-full bg-[#f6f4ef] px-6 text-sm font-medium text-[#0b1612] transition-colors hover:bg-white"
          ...
          <Link
            href={loginHref}
            onClick={onClose}
            className="saina-modal-cta inline-flex w-full items-center justify-center rounded-full border border-white/14 bg-transparent px-6 text-sm font-medium text-white/88 transition-colors hover:bg-white/6"
          ...
          <button
            type="button"
            onClick={onClose}
            className="saina-modal-cta inline-flex w-full items-center justify-center rounded-full px-6 text-sm font-medium text-white/52 transition-colors hover:text-white/72"
