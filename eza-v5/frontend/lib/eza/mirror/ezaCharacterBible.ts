...
export const CHARACTER_ARCHETYPES: Record<CharacterArchetypeId, CharacterArchetypeEntry> = {
  ...
  calm_panda: {
    ...
    visual: [
      'premium stylized calm panda adult editorial character',
      'mature stylized facial proportions subtle emotional realism',
      'natural wool linen fabric texture not plush toy',
      'refined eye spacing understated expression',
      'deep green and cream cinematic tones',
      'peaceful mature expression luxury animated feature tone',
      'editorial collectible character not mascot app',
    ],
    avoid: [
      'child panda toy',
      'sticker panda',
...
export function buildCharacterBiblePhrase(
  ...
  return [
    ...
    'premium editorial animated film aesthetic, mature stylized proportions, not plush not mascot',
