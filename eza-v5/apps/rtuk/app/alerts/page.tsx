 ...
 * 
 * Early warning without intervention.
...
export default function AlertsPage() {
  ...
  const [alerts, setAlerts] = useState<RTUKAlertsResponse | null>(null);
  ...
  useEffect(() => {
    ...
    const fetchAlerts = async () => {
      try {
        ...
        const response = await apiClient.get<RTUKAlertsResponse>('/api/proxy/rtuk/alerts');
      ...
      <div className="space-y-6">
        ...
        <div className="bg-blue-50 border-l-4 border-blue-400 p-4">
          <p className="text-sm text-blue-900">
            ...
            RTÜK, içerik müdahalesini bu panel üzerinden yapmaz.
            Uyarılar bilgilendirici, gözlemsel, kayıt altına alınmış ve sistem içinde işlem yapılamaz durumdadır.
          </p>
        </div>
        ...
        {loadingAlerts ? (
                    ...
                    <div className="flex-1">
                      ...
                      {alert.organization_id && (
                        <p className="text-xs text-gray-600 mt-2">
                          Organizasyon ID: {alert.organization_id}
                        </p>
                      )}
          ...
          <div className="bg-white rounded-lg shadow p-6 text-center">
            <p className="text-gray-500">Şu anda aktif uyarı bulunmamaktadır.</p>
          </div>
        )}
      </div>
    </RTUKLayout>
