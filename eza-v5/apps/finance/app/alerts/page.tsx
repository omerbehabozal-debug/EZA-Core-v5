...
import { apiClient, FinanceAlertsResponse } from '@/lib/api-client';
  ...
  useEffect(() => {
    ...
    const fetchAlerts = async () => {
      try {
        ...
        const response = await apiClient.get<FinanceAlertsResponse>('/api/proxy/finance/alerts');
      ...
      <div className="space-y-6">
        ...
        <div className="bg-blue-50 border-l-4 border-blue-400 p-4">
          <p className="text-sm text-blue-900">
            ...
            Finansal piyasa bütünlüğü ve tüketici güveni için erken uyarı sağlar.
          </p>
        </div>
        ...
        {loadingAlerts ? (
                    ...
                    <div className="flex-1">
                      ...
                      {alert.system_name && (
                        <p className="text-xs text-gray-600 mt-2">
                          Sistem: {alert.system_name} {alert.dependency_rate && `(%${alert.dependency_rate} bağımlılık)`}
                        </p>
                      )}
                      {alert.bias_event_count !== undefined && (
                        <p className="text-xs text-gray-600 mt-2">
                          Önyargı olay sayısı: {alert.bias_event_count}
                        </p>
                      )}
          ...
          <div className="bg-white rounded-lg shadow p-6 text-center">
            <p className="text-gray-500">Şu anda aktif finansal uyarı bulunmamaktadır.</p>
          </div>
        )}
      </div>
    </FinanceLayout>
